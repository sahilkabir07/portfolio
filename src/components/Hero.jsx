...
import PROFILE from "../assets/sahilProfile-Photoroom.jpg"
            ...
            <div className='flex flex-wrap lg:flex-row-reverse'>
                <div className='w-full lg:w-1/2'>
                    <div className='flex justify-center lg:p-8'>
                        <motion.img src={PROFILE} alt="Sahil Pic"
                            height={650}
                            width={650} className='border-stone-900 rounded-3xl'
                ...
                <div className='w-full lg:w-1/2 '>
                    <motion.div
                        initial="hidden"
                        animate="visible"
                        variants={containerVariants} className='flex flex-col items-start mt-10'>
                        <motion.h2
                            variants={childVariants} className='pb-2 text-4xl tracking-tighter lg:text-8xl'>
                            Sahil Akhtar
                        </motion.h2>
                        <motion.span
